        ...
        {stages.map((s, i) => {
          ...
          return (
            ...
            >
              ...
              <div className="h-7 rounded-lg overflow-hidden bg-[var(--surface-3)]">
                <div
                  className="h-full rounded-lg transition-[width,opacity] duration-500 ease-out"
                  style={{
        ...
        {items.map((it) => {
          ...
          return (
            ...
            >
              ...
              <div className="h-5 rounded-lg overflow-hidden bg-[var(--surface-3)] relative">
                <div
      ...
      <div className="space-y-2">
        {items.map((it, i) => (
          <div key={it.label} className="grid grid-cols-[6.5rem_1fr_auto] items-center gap-3">
            ...
            <div className="h-5 rounded-lg overflow-hidden bg-[var(--surface-3)]">
              <div
